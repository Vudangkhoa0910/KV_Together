...
import { ArrowLeft, Calendar, MapPin, Users, DollarSign, Mail, Phone, Upload, Star, TrendingUp } from 'lucide-react';
...
export default function EditFundraiserActivityPage() {
  ...
  const participationRate = (activity.current_participants / activity.max_participants) * 100;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <div className="mt-2">
              ...
              <p className="text-xs text-gray-500 mt-1">{Math.round(participationRate)}% đã đăng ký</p>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{activity.views_count}</p>
              </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{activity.days_until_event} ngày</p>
              </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-2">Cập nhật hình ảnh hoạt động</p>
              <button
                type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  min={activity.current_participants}
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="text-sm text-gray-500 mt-1">
                  Tối thiểu: {activity.current_participants} (số người đã đăng ký)
                </p>
              </div>
